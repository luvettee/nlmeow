...
local LastEventTick = common.get_timestamp()
events.post_render:set(function()
    if ( common.get_timestamp() - LastEventTick > 10 ) then
        ...
        LastEventTick = common.get_timestamp()
    end
end)

events.shutdown:set(function() _UnhandledEvents.shutdown() end)
